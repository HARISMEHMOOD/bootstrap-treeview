...
(function($, window, document, undefined) {
  ...
  Tree.prototype.dblClickHandler = function(event) {
    if (typeof this.options.onNodeDoubleClicked === "function") {
      var target = $(event.target);
      var node = this.findNode(target);
      this.options.onNodeDoubleClicked(event, node);
    }
  };
  ...
  Tree.prototype.clickHandler = function(event) {
    ...
    if (typeof this.options.onNodeClicked === "function") {
      this.options.onNodeClicked(event, node);
    }
  };
